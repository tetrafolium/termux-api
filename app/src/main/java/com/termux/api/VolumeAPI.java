...
public class VolumeAPI {
  ...
  static void onReceive(final TermuxApiReceiver receiver, final Context context,
                        final Intent intent) {
   ...
   */
  private static void printError(Context context, Intent intent,
                                 final String error) {
   ...
   */
  private static void setStreamVolume(Intent intent, AudioManager audioManager,
                                      int stream) {
    int volume =
        intent.getIntExtra("volume", audioManager.getStreamVolume(stream));
   ...
   */
  private static void printAllStreamInfo(Context context, Intent intent,
                                         final AudioManager audioManager) {
   ...
   */
  private static void getStreamsInfo(AudioManager audioManager, JsonWriter out)
      throws IOException {
    out.beginArray();
   ...
   */
  protected static void getStreamInfo(AudioManager audioManager, JsonWriter out,
