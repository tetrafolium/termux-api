  ...
  public static void onReceive(TermuxApiReceiver apiReceiver,
    ...
    ResultReturner.returnData(apiReceiver, intent, new ResultJsonWriter() {
      ...
      public void writeJson(JsonWriter out) throws Exception {
        ...
        // BatteryManager.EXTRA_PLUGGED: "Extra for ACTION_BATTERY_CHANGED:
        // integer indicating whether the device is plugged in to a power
        // source; 0 means it is on battery, other constants are different types
        // of power sources."
        int pluggedInt =
        ...
        case BatteryManager.BATTERY_STATUS_UNKNOWN:
          ...
          break;
        default:
          TermuxApiLogger.error("Invalid BatteryManager.EXTRA_STATUS value: " +
                                status);
          batteryStatusString = "UNKNOWN";
        }
        ...
        out.name("current").value(batteryManager.getLongProperty(
