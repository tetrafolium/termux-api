...
public class MicRecorderAPI {
  ...
  public static class MicRecorderService extends Service
    ...
    public void onCreate() { getMediaRecorder(this); }
    ...
    protected static RecorderCommandHandler
    getRecorderCommandHandler(final String command) {
    ...
    postRecordCommandResult(final Context context, final Intent intent,
    ...
    /**
     * Returns our MediaPlayer instance and ensures it has all the necessary
     * callbacks
     */
    ...
    protected static String getDefaultRecordingFilename() {
      ...
      return Environment.getExternalStorageDirectory().getAbsolutePath() +
          "/TermuxAudioRecording_" + dateFormat.format(date);
    }
    ...
    static RecorderCommandHandler recordHandler = new RecorderCommandHandler() {
      ...
      public RecorderCommandResult handle(Context context, Intent intent) {
        ...
        String sencoder =
            intent.hasExtra("encoder") ? intent.getStringExtra("encoder") : "";
        ...
        int format =
            intent.getIntExtra("format", MediaRecorder.OutputFormat.DEFAULT);
        ...
        int source =
            intent.getIntExtra("source", MediaRecorder.AudioSource.MIC);
        ...
        TermuxApiLogger.info("MediaRecording file is: " +
                             file.getAbsolutePath());

        if (file.exists()) {
          result.error = String.format(
              "File: %s already exists! Please specify a different filename",
              file.getName());
        } else {
          if (isRecording) {
            ...
            try {
              ...
              result.message = String.format(
                  ...
                  duration <= 0
                      ? "unlimited"
                      : MediaPlayerAPI.getTimeString(duration / 1000));
