...
public class SpeechToTextAPI {
  ...
  public static class SpeechToTextService extends IntentService {
    ...
    public SpeechToTextService(String name) { super(name); }
    ...
    public void onCreate() {
      ...
      mSpeechRecognizer.setRecognitionListener(new RecognitionListener() {
        ...
        public void onResults(Bundle results) {
          ...
          TermuxApiLogger.error("RecognitionListener#onResults(" +
                                recognitions + ")");
        ...
        public void onPartialResults(Bundle partialResults) {
          // Do nothing.
          List<String> strings = partialResults.getStringArrayList(
              SpeechRecognizer.RESULTS_RECOGNITION);
          TermuxApiLogger.error("RecognitionListener#onPartialResults(" +
                                strings + ")");
      ...
      List<ResolveInfo> installedList = pm.queryIntentActivities(
        ...
        new AlertDialog.Builder(context)
            ...
            .setPositiveButton(
                ...
                (dialog, which) -> {
                  ...
                  // setting flags to avoid going in application history
                  // (Activity call stack)
  ...
  public static void onReceive(final Context context, Intent intent) {
    context.startService(new Intent(context, SpeechToTextService.class)
  ...
  public static void runFromActivity(final Activity context) {
    ...
    if (speechRecognitionInstalled) {
      ...
      intent.putExtra(RecognizerIntent.EXTRA_PROMPT,
                      "Select an application"); // user hint
          ...
          .setPositiveButton(
              ...
              (dialog, which) -> {
                Intent intent = new Intent(
                    ...
                    Uri.parse(
                        "market://details?id=com.google.android.voicesearch"));
                // setting flags to avoid going in application history (Activity
                // call stack)
