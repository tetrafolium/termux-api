...
public class TextToSpeechAPI {
  ...
  public static class TextToSpeechService extends IntentService {
    ...
    public TextToSpeechService() { super(TextToSpeechService.class.getName()); }
        ...
        public void writeResult(PrintWriter out) {
          ...
          try {
            ...
            if ("LIST_AVAILABLE".equals(speechEngine)) {
              try (JsonWriter writer = new JsonWriter(out)) {
                ...
                for (EngineInfo info : mTts.getEngines()) {
                  ...
                  writer.name("default").value(
                      defaultEngineName.equals(info.name));
                  writer.endObject();
                }
                writer.endArray();
              }
                ...
                new UtteranceProgressListener() {
                  ...
                  public void onError(String utteranceId) {
                    TermuxApiLogger.error(
                        "UtteranceProgressListener.onError() called");
            ...
            if (speechLanguage != null) {
              int setLanguageResult = mTts.setLanguage(
                  getLocale(speechLanguage, speechRegion, speechVariant));
              if (setLanguageResult != TextToSpeech.LANG_AVAILABLE) {
                TermuxApiLogger.error("tts.setLanguage('" + speechLanguage +
                                      "') returned " + setLanguageResult);
              }
            }
