...
protected static MediaCommandHandler
getMediaCommandHandler(final String command) {
...
postMediaCommandResult(final Context context, final Intent intent,
...
static MediaCommandHandler infoHandler = new MediaCommandHandler() {
	@Override
	public MediaCommandResult handle(MediaPlayer player, Context context,
	                                 Intent intent) {
		MediaCommandResult result = new MediaCommandResult();
...
MediaCommandResult handle(MediaPlayer player, final Context context,
                          final Intent intent);
}
