...
public class TermuxApiPermissionActivity extends Activity {
  ...
  public static final String PERMISSIONS_EXTRA =
      "com.termux.api.permission_extra";
  ...
  public static boolean checkAndRequestPermissions(Context context,
    ...
    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
      ...
      if (permissionsToRequest.isEmpty()) {
        ...
        ResultReturner.returnData(
            context, intent, new ResultReturner.ResultJsonWriter() {
              ...
              public void writeJson(JsonWriter out) throws Exception {
                String errorMessage =
                    "Please grant the following permission" +
        ...
        Intent startIntent =
            new Intent(context, TermuxApiPermissionActivity.class)
                .addFlags(Intent.FLAG_ACTIVITY_NEW_TASK)
                .putStringArrayListExtra(
                    TermuxApiPermissionActivity.PERMISSIONS_EXTRA,
  ...
  protected void onResume() {
    super.onResume();
    ArrayList<String> permissionValues =
        getIntent().getStringArrayListExtra(PERMISSIONS_EXTRA);
